...
class Home extends Component {
    ...
    render() {
        ...
        const onSearch = () =>{ 
            ...
            axios.get("https://www.googleapis.com/books/v1/volumes?q="+ string +"+intitle:"+ string +"&startIndex=0&maxResults=40&orderBy=newest&key=AIzaSyD9_t-TTlRiYRGH-UxXjRLz773OyTFy3_U")
            .then(response => {
