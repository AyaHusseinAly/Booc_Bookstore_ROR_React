...
class AllStories extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div >
                {localStorage.getItem('user_id') && this.state.shortstoiesNotFinished.length + this.state.shortstoiesFinished.length == 0 && <div className='mt-5 pt-5' style={{ width: '100%', height: '100%' }}>
                ...
                {this.state.shortstoiesNotFinished.length + this.state.shortstoiesFinished.length > 0 && <div className='ml-5'>
                    {localStorage.getItem('user_id') && <div className='d-flex justify-content-end mr-2'>
                    ...
                    <h2 className='ml-3'>All Stories</h2>
                    <br />
